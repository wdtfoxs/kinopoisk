...
public class UserValid {
    ...
    @Size(min = 4, max = 20, message = "Фамилия пользователя должно состоять из 4 и более символов")
    @Pattern(regexp = "^[a-zA-Z0-9]+$", message = "Фамилия пользователя должно состоять из букв и цифр латинского языка")
