            ...
            <div class="row">
                <div class="container">
                    <div class="col-md-6 form-inline">
                        ...
                        <button type="button" class="btn btn-primary" onclick="showsearch()">\/</button>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6 form-inline" hidden id="sh_search">
                        ...
                        <input class="form-control" ng-model="search_by_actor_Input" id="search_by_actor"
                               ng-change="search_by_actor()"
                ...
                <div class="col-lg-9">
                    <table class="table table-striped col-md-6">
                        ...
                        <tr ng-repeat="movie in movies">
                            ...
                            <td><img ng-src="{{movie.image}}" class="thumbnail" width="100px" height="137px">
                            </td>
