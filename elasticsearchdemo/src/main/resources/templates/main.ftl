...
<div class="content">
    ...
    <div class="box_2">
                ...
                <div class="col-md-6 grid_7">
                    <div class="col_2">
                        <ul class="list_4">
                            ...
                            <li><i class="icon3"> </i>
                                <p>546</p></li>
                            <li>Rating : &nbsp;&nbsp;<p><img src="../../resources/images/rating1.png" alt=""/></p></li>
                            <li>Release Date : &nbsp;<span class="m_4">Mar 15, 2015</span></li>
                            <div class="clearfix"></div>
                        </ul>
                        <div class="m_5"><a href="single.html"><img src="../../resources/images/pic3.jpg"
        ...
        <div class="col-md-2 grid_6">
            <div class="m_7"><a href="single.html"><img src="../../resources/images/pic9.jpg" class="img-responsive"
                                                        alt=""/></a></div>
            <div class="caption1">
                <ul class="list_5">
                    <li><i class="icon5"> </i>
            ...
            <div class="col_2 col_3">
                ...
                <div class="m_8"><a href="single.html"><img src="../../resources/images/pic10.jpg"
                                                            class="img-responsive" alt=""/></a></div>
            </div>
        </div>
        <div class="clearfix"></div>
