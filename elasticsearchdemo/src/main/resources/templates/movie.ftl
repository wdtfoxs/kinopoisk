                        ...
                        <#if canvote == 1>
                            <fieldset class="rating2" id="rating">
                                <input type="radio" id="star5" name="rating" value="5"
                                       onclick="rate5(${movie.id})"/><label class="full" for="star5"
                                ...
                                <input type="radio" id="star1" name="rating" value="1"
                                       onclick="rate1(${movie.id})"/><label class="full" for="star1"
    ...
    <p class="movie_option"><strong>Year: </strong>
        ...
        <p class="movie_option"><strong>Year: </strong>
            ...
            <p class="movie_option"><strong>Awards: </strong>
                <#if movie.awards??>
                    <#list movie.awards as a>
                        <a href="/award/${a.id}">${a.name}</a>,
                    </#list>
                </#if>
            </p>
            <p class="movie_option"><strong>Director: </strong>
                <#list movie.peoples as p>
                    <#if p.role == "DIRECTOR">
                        <a href="/actor/${p.id}">${p.name} ${p.surname}</a>,
                    </#if>
                </#list>
            </p>
